// This code is modified from http://dev.qu.tu-berlin.de/projects/sf-razor-9dof-ahrs
...
#define ACCEL_X_MIN (-317.0f)
#define ACCEL_X_MAX (250.0f)
#define ACCEL_Y_MIN (-296.0f)
#define ACCEL_Y_MAX (300.0f)
#define ACCEL_Z_MIN (-277.0f)
#define ACCEL_Z_MAX (279.0f)

// Magnetometer
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
#define MAGN_X_MIN ((float)-601)
#define MAGN_X_MAX ((float)134)
#define MAGN_Y_MIN ((float)-300)
#define MAGN_Y_MAX ((float)442)
#define MAGN_Z_MIN ((float)-236)
#define MAGN_Z_MAX ((float)417)


// Magnetometer (extended calibration mode)
// Uncommend to use extended magnetometer calibration (compensates hard & soft iron errors)
#define CALIBRATION__MAGN_USE_EXTENDED true
const float magn_ellipsoid_center[3] = {-206.868, 54.8792, 83.7642};
const float magn_ellipsoid_transform[3][3] = {{0.802115, 0.0615970, 0.0965972}, {0.0615970, 0.865788, -0.0702850}, {0.0965972, -0.0702850, 0.938787}};
...
boolean output_sensor_acc(float *arr, int num){
  if(num < 3){
    return false;
  }
  else{
    arr[0] = Accel_Vector[0];
    arr[1] = Accel_Vector[1];
    arr[2] = Accel_Vector[2];
    return true;
  }
}

boolean output_sensor_dir(float *dir, int num){
  if(num < 3){
    return false;
  }
  else{
